...
// The one-time SQLite backfill migration (075_api_key_self_service_usage_scopes.sql)
// that used to be covered here has no Postgres equivalent: db/migrations/postgres/
// only carries the consolidated 0001_baseline.sql schema forward, and the live
// create-time default is normalizeSelfServiceScopesForCreate(), already covered by
