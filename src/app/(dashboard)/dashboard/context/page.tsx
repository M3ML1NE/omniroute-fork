...
// route 404'd. Redirect the parent to its canonical sub-route, honoring a
// legacy `?tab=` query for deep links.
//
// Adaptation: the upstream `llmlingua`/`omniglyph` tabs are not part of the
// GigaChat fork, so they are omitted from the tab map.
