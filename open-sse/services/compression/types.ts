...
export interface CompressionConfig {
   ...
   * (preserved, not compressed). Its authoritative *intent* is
   * `preserveSystemPromptMode` (T05/C5); this boolean is the no-cache projection.
   */
   ...
   * and dispatch falls back to the legacy `defaultMode`/default-combo path. Set by
