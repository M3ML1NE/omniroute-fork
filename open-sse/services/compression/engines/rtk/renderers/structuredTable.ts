 ...
 *
 * Renders only an array of ≥2 homogeneous objects into a minimal TSV-like table (header +
 * rows, columns capped at MAX_COLUMNS, rows capped at MAX_TABLE_ROWS with a "… (+K more)"
 * tail). Every other shape ⇒ no-op (conservative).
 */
