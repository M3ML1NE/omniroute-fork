...
// Exported so outputStyles/catalog.ts can reference the localized terse-prose instruction
// text verbatim (byte-identical back-compat with the legacy caveman output mode) rather than
// re-typing it. Ported alongside the `id` locale from OmniRoute upstream v3.8.48.
