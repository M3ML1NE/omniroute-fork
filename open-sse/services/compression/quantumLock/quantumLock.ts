...
export function detectVolatileSpans(text: string, cfg: QuantumLockConfig): VolatileSpan[] {
  ...
  // span's end. A nested or partially-overlapping span is dropped whole (never split) — this
  // can only under-stabilize, never corrupt text or shift placeholder numbering.
