// Ported verbatim from OmniRoute upstream v3.8.48 (GigaChat fork).
// No removed-subsystem references — the styles depend only on outputMode.ts, which the fork ships.
